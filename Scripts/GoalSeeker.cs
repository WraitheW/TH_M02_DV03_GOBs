...
public class GoalSeeker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        actions[3].goals.Add(new Goals("Sleep", +3f));
        ...
        actions[5].goals.Add(new Goals("Work", -2f));
        actions[5].goals.Add(new Goals("Eat", +1f));
        actions[5].goals.Add(new Goals("Sleep", +3f));
